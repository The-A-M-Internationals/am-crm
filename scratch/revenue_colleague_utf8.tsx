...
export default function RevenuePage() {
  ...
  const downloadPDFReport = async () => {
    ...
    doc.text(
      "ΓÇó This report summarizes revenue, expenses and profitability based on paid invoices.",
      20,
      notesY + 16,
    );

    doc.text(
      "ΓÇó Revenue values are normalized into AED for consistent financial reporting.",
      20,
      notesY + 24,
    );

    doc.text(
      "ΓÇó Generated automatically from the A&M International CRM.",
      20,
      notesY + 32,
    );

    doc.text(
      "ΓÇó Intended for Management, Finance Team and Founders.",
      20,
      notesY + 40,
    );
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="page-header mb-0">
          ...
          <p className="page-subtitle">
            Financial overview ΓÇö Admin only ┬╖ {year}
          </p>
        </div>
