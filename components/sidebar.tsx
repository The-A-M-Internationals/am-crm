...
const I = {
  ...
  proposals: <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/></svg>,
...
const NAV: NavItem[] = [
  { href: "/dashboard",  label: "Dashboard",  roles: ["admin","manager","sales","designer"], icon: I.dashboard,  section: "main" },
  { href: "/leads",      label: "Leads",      roles: ["admin","manager","sales"],            icon: I.leads,      section: "main" },
  { href: "/clients",    label: "Clients",    roles: ["admin","manager","sales","designer"], icon: I.clients,    section: "main" },
  { href: "/projects",   label: "Projects",   roles: ["admin","manager","sales","designer"], icon: I.projects,   section: "main" },
  { href: "/proposals",  label: "Proposals",  roles: ["admin","manager","sales"],            icon: I.proposals,  section: "main" },
  { href: "/tasks",      label: "Tasks",      roles: ["admin","manager","sales","designer"], icon: I.tasks,      section: "main" },
  { href: "/calendar",   label: "Calendar",   roles: ["admin","manager","sales","designer"], icon: I.calendar,   section: "main" },
...
const roleColors: Record<UserRole, string> = {
  admin: "#C9A84C", manager: "#60a5fa", sales: "#34d399", designer: "#f472b6",
};
    ...
    <div className="h-screen w-[220px] flex-shrink-0 flex flex-col" style={{ background: "linear-gradient(180deg, #0D1B3E 0%, #07112a 100%)", borderRight: "1px solid rgba(201,168,76,0.1)" }}>
      ...
      {crmUser && (
        <div className="px-3 py-4 border-t" style={{ borderColor: "rgba(201,168,76,0.1)" }}>
          ...
          <button onClick={signOut} className="sidebar-link w-full text-left" style={{ color: "#ef4444", background: "rgba(239,68,68,0.08)", borderRadius: "8px", border: "1px solid rgba(239,68,68,0.2)" }}>
