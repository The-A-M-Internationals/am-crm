...
export default function ClientsPage() {
  ...
  async function deleteClient(id: string) {
    if (
      !confirm(
        "PERMANENT DELETE: Are you sure you want to completely remove this client? This will also delete all their projects, tasks, invoices, proposals, and leads. This cannot be undone."
      )
    )
      return;
    try {
    ...
    <div className="p-8">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          >
            <h1 className="page-title flex items-center gap-3" style={{ color: "#0D1B3E", fontFamily: "var(--font-playfair)" }}>
              ...
              >
                ...
                <div className="flex flex-col h-full">
                  <div className="flex justify-between items-start mb-6">
                    ...
                    <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-all z-10 relative">
                      ...
                      <button 
                        onClick={(e) => {
                          e.stopPropagation();
                          toggleLostStatus(client);
                        }}
                        className="w-8 h-8 rounded-full flex items-center justify-center text-slate-300 hover:bg-slate-50 hover:text-amber-500 transition-all"
                        title={client.active === false ? "Recover Client" : "Archive Client"}
                      >
                        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M21 4H8l-7 8 7 8h13a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2z"></path><line x1="18" y1="9" x2="12" y2="15"></line><line x1="12" y1="9" x2="18" y2="15"></line></svg>
                      </button>
                      <button 
                        onClick={(e) => {
                          e.stopPropagation();
                  ...
                  <div className="flex flex-col gap-3 mb-6 flex-grow">
                    ...
                    <div className="grid grid-cols-2 gap-4 mt-2 mb-2 p-3 bg-slate-50/50 rounded-xl border border-slate-100">
                      <div>
                        <p className="text-[9px] font-bold text-slate-400 uppercase tracking-wider mb-1">
                          Contact
                        </p>
                        <p className="text-xs font-semibold text-slate-700 truncate" title={client.email}>
                          {client.email}
                        </p>
                        ...
                        <div className="flex flex-wrap gap-1">
                          {(client.services ?? []).map((svc) => {
                            ...
                            return s ? (
                              <span
                                key={svc}
                                className="px-1.5 py-0.5 rounded text-[8px] font-bold uppercase tracking-widest border border-slate-200"
                  ...
                  <div className="mt-auto pt-4 border-t border-slate-100 flex items-center justify-between">
                    <div className="flex gap-4">
                      <div className="flex items-center gap-1.5">
                        <span className="w-5 h-5 rounded bg-indigo-50 text-indigo-600 flex items-center justify-center text-[10px] font-bold">
                      ...
                      <div className="flex items-center gap-1.5">
                        <span className="w-5 h-5 rounded bg-amber-50 text-amber-600 flex items-center justify-center text-[10px] font-bold">
                          {clientTasks.length}
                        </span>
                        <span className="text-[11px] font-bold text-slate-500">
                          Tasks
